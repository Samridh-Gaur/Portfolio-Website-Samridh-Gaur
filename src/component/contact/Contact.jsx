                ...
                <div className="contact_content">
                    ...
                    <div className="contact_info">
                        <div className="contact_card">
                            ...
                            <span className="contact_card-data">samridhgaur2005@gmail.com</span>

                            <a href="mailto:samridhgaur2005@gmail.com" target="_blank" className="contact_button">Write me<i className="bx bx-right-arrow-alt contact_button-icon"></i>
                            </a>
                        </div>
                        ...
                        <div className="contact_card">
                            ...
                            <span className="contact_card-data">+91-9461936332</span>

                            <a href="https://api.whatsapp.com/send?phone=919461936332&text=Hello, Samridh!" target="_blank" className="contact_button">Write me 
